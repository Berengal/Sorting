...
public class MemoryArray {
  ...
  private int swaps = 0;
  static MemoryArray newInstance(final int size, int maxValue, final String label) {
  ...
  public static MemoryArray shuffledInstance(final int size, final String label) {
    Element[] elements = new Element[size];
    for (int i = 0; i < elements.length; i++) {
